...
const InvoiceGenerator: React.FC<Props> = ({ onSave, editId }) => {
  // Masters Data
  ...
  useEffect(() => {
    ...
    if(editId) {
        ...
        const found = invs.find(i => i.id === editId);
        if(found) {
    ...
    <div className="max-w-5xl mx-auto pb-12">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-3">
          <button 
             ...
             className="flex items-center px-4 py-2 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg text-slate-700 dark:text-slate-200 hover:bg-slate-50"
          >
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Place of Supply</label>
            <input 
              disabled 
        ...
        {selectedCustomerId && (
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-600 dark:text-slate-400">
             <p><span className="font-semibold">Address:</span> {customerDetails.billingAddress}</p>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-6 mb-6">
        <h2 className="text-lg font-semibold mb-4 text-slate-800 dark:text-white">Product Items</h2>
